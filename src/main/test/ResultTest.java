...
public class ResultTest {
	...
	public void testCreate() throws Exception {
		Result testResult = new Result(1, 7.75, "ppm", "17:42:58 17/11/2023", 3);
		...
		assertEquals(testResult.getSensorId(), 6);
	}
